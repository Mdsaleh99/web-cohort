...
A: In `Server-side routing or rendering (SSR)`, every change in URL, http request is made to server to fetch the webpage (html, css and js), and replace the current webpage with the older one.
