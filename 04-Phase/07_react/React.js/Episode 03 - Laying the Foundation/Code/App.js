...
// * React.createElement is an Object when it is created, but when it is rendered to the DOM, it becomes an HTMLElement.
...
// * JSX is not part of React, JSX is different and React is different
...
const jsxHeading = <h1 id="heading">Namaste React Using JSX🚀</h1>; // it is like create element. this syntax does not understand by js engine, this syntax converted in to react element and then rendered as a HTML element, who is coverting this jsx code it is converting by babel jsx to React.createElement(), babel does more other things also
