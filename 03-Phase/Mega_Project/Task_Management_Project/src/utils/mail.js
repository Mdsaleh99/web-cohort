 ...
 */
const sendEmail = async (options) => {  // options ek object hoga for mailgen
...
// priority for emailHtml by default if it doesn't load emailText will be loaded
// mailgen mail craft (design) karne k liye and nodemailer mail send karne k liye hai

// factory functions or factory patterns - we using this design pattern because we send email for different purpose like forgot password, verification etc
/**
 *
